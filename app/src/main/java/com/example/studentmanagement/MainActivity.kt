...
import com.example.studentmanagement.controller.StudentActionListener
...
class MainActivity : AppCompatActivity(), StudentActionListener {
    ...
    private fun showAddStudentFragment() {
        FragmentSingleton.onStudentAddedListener = object : AddStudentFragment.OnStudentAddedListener {
    ...
    override fun onStudentEditClicked(position: Int, student: Student) {
        FragmentSingleton.studentActionListener = this
        FragmentSingleton.student = student
        FragmentSingleton.position = position
    ...
    private fun setupSwipeToDelete() {
        val itemTouchHelperCallback = object : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                onStudentDeleteClicked(position, students[position])
            }
        }
